          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              ...
              <div className="testimonial-item wow fadeInUp delay-0-2s">
                <div className="author">
                  <img src="assets/images/testimonials/shiva-nampalli.jpeg" alt="Author" />
                </div>
                {/* <div className="text">
            ...
            <div className="col-lg-6 col-md-6">
              ...
              <div className="testimonial-item wow fadeInUp delay-0-4s">
                <div className="author">
                  <img src="assets/images/testimonials/divakar-mikkilineni2.jpeg" alt="Author" />
                </div>
                {/* <div className="text">
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="testimonial-item wow fadeInUp delay-0-6s">
                ...
                <div className="testi-des">
                  <h5>Sambi Gaadu</h5>
                  <span>Cycle ki patch lu ethaadu</span>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="testimonial-item wow fadeInUp delay-0-8s">
                ...
                <div className="testi-des">
                  <h5>Suri gaadu</h5>
                  <span>Cheruku rasam ammuthaadu</span>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="testimonial-item wow fadeInUp delay-0-9s">
                ...
                <div className="testi-des">
                  <h5>Bujji gaadu</h5>
                  <span>Black ticket lu ammuthaadu</span>
                </div>
              </div>
